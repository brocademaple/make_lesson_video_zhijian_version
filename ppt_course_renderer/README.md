...
- **CLI 生成**：`ppt-course remotion-render-plan <task_id>` 生成 director-aware `render_plan/input-props`；`ppt-course remotion-input-props <task_id> -o <path>` 保留为低层 fallback 命令。
